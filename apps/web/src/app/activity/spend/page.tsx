...
export default function ActivitySpendPage() {
  ...
  const pills = (
    <div className="flex shrink-0 items-center gap-0.5 rounded-lg bg-[color:var(--surface-muted)] p-0.5">
      {RANGES.map((r) => {
  ...
  return (
    <ActivityShell
      title="Spend"
      subtitle="Tokens and cost across your automation runs."
      actions={pills}
    >
      {!loaded ? (
